...
Unsupported positions, including `SUPERFLEX`, `OP`, `DST`, `D/ST`, `DEF`, `LB`, `DB`, and other IDP positions, score `0` and are not part of the game. The UI/API must not expose DST or IDP scoring settings.
