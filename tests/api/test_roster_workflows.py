        ...
        json=[
            {
                ...
                "sheet_source_sheet_id": "canonical-preseason:2026:test-roster-workflows",
            },
            {
                "external_id": None,
                "name": "Runner Two",
...
def test_weekly_waiver_clear_opens_instant_adds_only_for_that_game_week(client, db_session, monkeypatch):
    ...
    cleared_at = datetime(2026, 9, 7, 13, 0, tzinfo=timezone.utc)
        ...
        json=[
            {
                ...
                "school": "Georgia",
                "image_url": None,
                "sheet_projected_season_points": 150.0,
                "sheet_source_sheet_id": "canonical-preseason:2026:test-roster-workflows",
            }
        ],
        headers=admin_headers(client),
    ...
    next_week = datetime(2026, 9, 8, 15, 0, tzinfo=timezone.utc)
