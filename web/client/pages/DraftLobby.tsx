...
export default function DraftLobby() {
  ...
  const canEnter = ["countdown", "live", "paused"].includes(draftRoom?.status ?? "");
  ...
  }, [draftRoom?.seconds_remaining, draftRoom?.status, draftRoom?.current_pick]);
        ...
        <CardContent className="p-5 space-y-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] px-4 py-3">
            ...
            <p className="mt-1 text-[9px] font-black uppercase tracking-[0.14em] text-muted-foreground/75">
              Start Draft triggers a 60-second countdown. No picks are processed until the countdown reaches 0.
            </p>
          </div>
