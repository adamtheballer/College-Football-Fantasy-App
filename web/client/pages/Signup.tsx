  ...
  return (
    <div className="relative h-full max-h-full overflow-hidden rounded-[2rem] border border-white/10 bg-[#06111f] p-3 shadow-[0_0_80px_rgba(14,165,233,0.18)] sm:p-4 lg:p-5">
      ...
      <div className="relative grid h-full min-h-0 items-center gap-5 lg:grid-cols-[minmax(0,1fr)_440px]">
        <section className="hidden -translate-y-10 space-y-5 pl-2 lg:block xl:pl-6">
          <Link
            to="/"
        ...
        <div className="mx-auto w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <Card className="relative overflow-hidden rounded-[1.75rem] border border-white/15 bg-slate-950/72 shadow-[0_28px_80px_rgba(0,0,0,0.42)] backdrop-blur-2xl">
            ...
            <CardContent className="relative space-y-4 p-4 sm:p-5">
              <div className="space-y-1.5 text-center">
                <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-200 via-cyan-300 to-blue-500 shadow-[0_0_38px_rgba(34,211,238,0.34)]">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="group relative">
                      ...
                      <Input
                        ...
                        className="h-11 rounded-2xl border-cyan-200/10 bg-white/10 pl-12 text-sm font-bold text-white placeholder:text-slate-300/40 transition-all focus:border-cyan-200/50 focus:ring-cyan-300/25"
                        value={firstName}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="group relative">
                      ...
                      <Input
                        ...
                        placeholder="••••••••"
                        className="h-11 rounded-2xl border-cyan-200/10 bg-white/10 pl-12 pr-12 text-sm font-bold text-white placeholder:text-slate-300/40 transition-all focus:border-cyan-200/50 focus:ring-cyan-300/25"
                        value={password}
                ...
                <div className="grid gap-1.5 rounded-2xl border border-cyan-200/10 bg-white/[0.06] p-2.5" aria-live="polite">
                ...
                <Button
                  type="submit"
                  className="group h-11 w-full overflow-hidden rounded-2xl bg-gradient-to-r from-cyan-300 via-sky-400 to-blue-500 text-[10px] font-black uppercase tracking-[0.2em] text-slate-950 shadow-[0_18px_42px_rgba(14,165,233,0.32)] transition-all hover:brightness-110"
                  disabled={isLoading}
                >
                  {isLoading ? (
              ...
              <div className="grid grid-cols-3 gap-3">
                <Button variant="outline" className="h-10 rounded-2xl border-white/10 bg-white/10 text-white hover:border-cyan-200/35 hover:bg-cyan-300/15">
                  <Chrome className="h-5 w-5" />
                </Button>
                <Button variant="outline" className="h-10 rounded-2xl border-white/10 bg-white/10 text-white hover:border-amber-200/35 hover:bg-amber-300/15">
                  <Apple className="h-5 w-5" />
                </Button>
                <Button variant="outline" className="h-10 rounded-2xl border-white/10 bg-white/10 text-white hover:border-rose-200/35 hover:bg-rose-300/15">
                  <Github className="h-5 w-5" />
                </Button>
              </div>
            </CardContent>

            <div className="relative border-t border-white/10 bg-white/[0.06] px-6 py-2.5 text-center">
          ...
          <div className="mt-2 flex items-center justify-center gap-5 text-slate-200/55">
