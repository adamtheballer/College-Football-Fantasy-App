        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-400">
              League-scoped available players only. Ownership in other leagues does not remove a player here.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div>
              ...
              <p className="mt-2 text-xs font-semibold text-slate-500">
                Hover a player to evaluate the claim. Position color shows roster role.
              </p>
            </div>
        ...
        {filteredPlayers.length === 0 ? (
          ...
          <div className="divide-y divide-sky-300/10">
            {filteredPlayers.map((player, index) => {
              ...
              <div
                key={player.id}
                className="group relative grid gap-4 px-5 py-4 text-sm text-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:bg-sky-300/[0.045] hover:shadow-[inset_4px_0_0_rgba(125,211,252,0.5),0_18px_50px_rgba(14,165,233,0.10)] md:grid-cols-[64px_minmax(0,1.35fr)_0.8fr_140px_150px]"
              >
                ...
                <div className="flex items-center">
                  <div className="w-full">
                    ...
                    <div className="h-2 overflow-hidden rounded-full bg-slate-950/80">
                      <div
                        className="h-full rounded-full bg-gradient-to-r from-sky-300 via-cyan-200 to-blue-400 shadow-[0_0_18px_rgba(56,189,248,0.34)]"
                        style={{ width: `${share}%` }}
                      />
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  <Button
                    type="button"
                    className="h-11 rounded-2xl bg-gradient-to-r from-sky-300 to-blue-500 px-4 text-[10px] font-black uppercase tracking-[0.16em] text-slate-950 shadow-[0_12px_34px_rgba(14,165,233,0.24)] transition-all hover:brightness-110"
                  >
