...
import type {
  MockDraftEmailSummaryResponse,
  MockDraftPreview,
  MockDraftQueue,
  MockDraftRoom,
  MockDraftRoomSnapshot,
  MockDraftSession,
...
export function useMockDraftEmailSummary(mockDraftId?: number) {
  return useMutation({
    mutationFn: (payload: { send_to_account_email: boolean; additional_email?: string | null }) =>
      apiPost<MockDraftEmailSummaryResponse>(`/mock-drafts/${mockDraftId}/email-summary`, payload),
  });
}
