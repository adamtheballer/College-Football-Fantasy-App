...
export function FloatingQuickActions() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-[calc(6rem+env(safe-area-inset-bottom))] right-4 z-[160] flex flex-col items-end gap-3 lg:bottom-8 lg:right-8 lg:z-[180]">
      <div
        className={cn(
