...
export function PlaybookDecor({ className }: { className?: string }) {
  return (
    <div aria-hidden="true" className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      <div className="absolute -right-24 top-6 h-2 w-56 rotate-[-18deg] rounded-full bg-cfb-crimson/40 blur-[1px]" />
      ...
      <svg className="absolute bottom-6 right-8 h-10 w-24 text-cfb-crimson/28" viewBox="0 0 112 48" fill="none">
        <path
