...
export function DraftRoomVisuals() {
  return (
    <>
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-32 top-20 h-5 w-[30rem] rotate-[-9deg] bg-gradient-to-r from-transparent via-amber-200/20 to-transparent blur-sm"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-28 bottom-24 h-4 w-[26rem] rotate-[11deg] bg-gradient-to-r from-transparent via-cyan-200/16 to-transparent blur-sm"
      />
      <svg
        aria-hidden="true"
      ...
      >
        <path
          d="M54 94 C166 74 192 178 302 160 S438 74 594 112"
          stroke="currentColor"
          strokeDasharray="7 12"
          strokeWidth="2"
        />
        <path
          d="M92 318 C204 272 266 388 400 326 S532 228 658 268"
          stroke="currentColor"
          strokeDasharray="7 12"
          strokeWidth="2"
        />
        ...
        />
        <path
          d="M264 108 l28 28 m0 -28 -28 28 M340 260 l28 28 m0 -28 -28 28"
          stroke="currentColor"
          strokeWidth="3"
        />
        <text x="78" y="240" fill="currentColor" fontSize="38" fontWeight="800">
          O
        </text>
        <text
          x="626"
