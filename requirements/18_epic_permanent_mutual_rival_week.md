...
Managers may form one mutually accepted, permanent rivalry per league after the draft completes. Rivalries are social metadata only: they never change scoring, projections, scheduling, standings, playoffs, waivers, trades, or draft behavior. Any canonical matchup between accepted rivals receives Rival Week context and presentation.
...
- As a rival, I see Rival Week only when our canonical matchup actually occurs.
...
- Rival Week presentation is original, accessible, responsive, reduced-motion-safe, and only appears for the actual rivalry matchup.
