...
class LeaguePostseasonSettings(TimestampMixin, Base):
    ...
    calendar_policy_version: Mapped[str] = mapped_column(String(48), nullable=False, default="P4_FULL_COVERAGE_V2")
    calendar_source_identity: Mapped[str] = mapped_column(String(256), nullable=False, default="UNSET")
    calendar_source_revision: Mapped[str] = mapped_column(String(128), nullable=False, default="UNSET")
    calendar_source_sha256: Mapped[str] = mapped_column(String(64), nullable=False, default="UNSET")
    calendar_source_format_version: Mapped[str] = mapped_column(String(48), nullable=False, default="SEALED_CFB_SCHEDULE_V1")
