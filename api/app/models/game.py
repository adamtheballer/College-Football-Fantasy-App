...
class Game(TimestampMixin, Base):
    ...
    home_provider_team_id: Mapped[str | None] = mapped_column(String(120), nullable=True)
    away_provider_team_id: Mapped[str | None] = mapped_column(String(120), nullable=True)
