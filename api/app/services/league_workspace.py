...
def build_matchup_summary(
    ...
    return LeagueWorkspaceMatchupSummaryRead(
        ...
        manager_name_for=my_team.manager_name,
        manager_avatar_url_for=my_team.owner_avatar_url,
        opponent_manager_name=opponent_team.manager_name,
        opponent_manager_avatar_url=opponent_team.owner_avatar_url,
...
def build_league_list_current_user_summary(
    ...
    return LeagueListCurrentUserSummaryRead(
        ...
        manager_name_for=matchup.manager_name_for if matchup else owned_team.owner_name,
        manager_avatar_url_for=matchup.manager_avatar_url_for if matchup else current_user.avatar_url,
        ...
        opponent_manager_name=matchup.opponent_manager_name if matchup else None,
        opponent_manager_avatar_url=matchup.opponent_manager_avatar_url if matchup else None,
