...
from collegefootballfantasy_api.app.models.draft_lobby_member import DraftLobbyMember
from collegefootballfantasy_api.app.models.draft_pick import DraftPick
from collegefootballfantasy_api.app.models.draft_team_queue_item import DraftTeamQueueItem
from collegefootballfantasy_api.app.models.draft_timer_state import DraftTimerState
...
from collegefootballfantasy_api.app.schemas.audit import AdminActionListRead, AdminActionRead
...
from collegefootballfantasy_api.app.services.league_week_state import (
...
from collegefootballfantasy_api.app.services.admin_actions import append_admin_action, list_admin_actions
...
from collegefootballfantasy_api.app.services.event_stream import (
    append_league_event,
...
def _reset_draft_timer_for_next_pick(
    *,
    ...
    timer_state.timer_started_at = now_utc + timedelta(seconds=delay)
    timer_state.paused_at = None
...
def _draft_room_state(db: Session, league: League, current_user: User) -> DraftRoomRead:
    ...
    if draft_row.status in {"scheduled", "countdown", "live", "paused"}:
        ...
        if seconds_remaining is not None and draft_row.status != "paused" and current_team is not None:
...
def _setup_draft_practice(
    ...
    *,
    ...
    if not settings_row:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="league settings not found")
    # Draft sandbox branch enforces a fixed 13-slot roster for deterministic round math.
