...
SOURCE_PATH = PROJECT_ROOT / "api" / "app" / "data" / "cfb27_ratings_2026-08-04.csv"
...
def render_frontend_module(rows: list[tuple[int, str, str, str, int]]) -> str:
    ...
    return f"""// Generated by scripts/generate_cfb27_frontend.py from api/app/data/cfb27_ratings_2026-08-04.csv.
